async function xinghuo_max_Translate(text, source_lang, target_lang) {
    try {
      ...
      const headers = {
        ...
        "Authorization": `Bearer ${process.env.XINGHUO_MAX_API_KEY}`,
      };
      ...
      console.error("xinghuo_max error:", error);
      return null;
    }
  }

  export { xinghuo_max_Translate };
